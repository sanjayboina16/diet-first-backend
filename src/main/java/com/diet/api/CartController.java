...
public class CartController {
	...
	public Cart findById(@RequestParam int id) {
		 ...
		 Cart doctor =doctorRepo.findById(id).get();
	...
	public String addProduct(@RequestParam ("dietFile") MultipartFile myFile,
		...
		try {
			Cart prdImage = new Cart(name,degree,spl,exp,address,phone,
	...
	public List<Cart> deleteDoctor(@RequestParam int id){
	...
	public List<Cart> getAllProducts(){
		...
		List<Cart> drList = new ArrayList<Cart>();
		
		List<Cart> resDrList = doctorRepo.findAll();
		Cart doctor = null;
